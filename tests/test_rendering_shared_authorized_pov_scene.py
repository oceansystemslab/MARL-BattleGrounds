...
def test_catalog_unrepresented_inert_and_represented_clamp_sensitive(
    shared_case: _SharedCase,
) -> None:
    ...
    inert = _build(shared_case, 0, catalog=unrepresented)
    assert _canonical_bytes(inert) == _canonical_bytes(baseline)
