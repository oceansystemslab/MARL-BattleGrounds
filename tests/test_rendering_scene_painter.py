...
def production_painter_cases() -> _ProductionPainterCases:
    ...
    team_deathmatch = captured_team_deathmatch_threshold_trajectory()
    team_deathmatch_view = EvaluationTransitionViewV1(
        context=team_deathmatch.context,
        start_frame=team_deathmatch.frames[0],
        transition=team_deathmatch.transitions[0],
        successor_frame=team_deathmatch.frames[1],
    )
    team_deathmatch_evidence = advance_status_source_evidence_v2(
        initialize_status_source_evidence_v2(
            team_deathmatch.context,
            team_deathmatch.frames[0],
        ),
        team_deathmatch_view,
    )
    team_deathmatch_projection = build_researcher_analyzer_projection_v2(
        team_deathmatch.context,
        team_deathmatch.frames[1],
        transition_view=team_deathmatch_view,
        status_source_evidence_state=team_deathmatch_evidence,
    )
    vocabulary = (
        *moving,
